...
export class MemoryStore {
  ...
  private async buscarPorTipo(
    ...
    // Para negocio e referencia (globais), busca sem filtro de chatId
    // Para cliente e licao, busca filtrado por chatId
    if (tipo === 'negocio' || tipo === 'referencia') {
      return await memoryDB.getRelevantes(null, mensagem, max);
    }
    return await memoryDB.getRelevantes(chatId, mensagem, max);
  }
