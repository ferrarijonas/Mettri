 ...
 * ResponderPanel (mock)
 *
 * Tela placeholder para o fluxo "Responder".
 * Mantém o design desacoplado (estrutura aqui, estilo via tokens/classes existentes).
 */

export class ResponderPanel {
    ...
    root.innerHTML = `
      <div class="glass-subtle rounded-xl p-3">
        ...
        <div class="text-xs text-muted-foreground mt-1">
          Mock: aqui ficará o fluxo de responder (com aprovação humana).
        </div>
      </div>
