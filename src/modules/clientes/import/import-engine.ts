...
export function inferMappingFromHeaders(headers: string[]): {
  ...
  const synonyms: Record<ImportFieldId, string[]> = {
    phone: [
      'phone', 'telefone', 'celular', 'mobile', 'whatsapp', 'telefono', 'tel',
      'contact phone', 'numero', 'number', 'fone', 'fone principal', 'telefone principal',
    ],
    phoneAlt: [
      'phone alt', 'telefone 2', 'telefone alternativo', 'celular 2', 'telefono 2',
      'tel 2', 'fone 2', 'telefone secundario',
    ],
