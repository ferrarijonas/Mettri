/**
 * Ícones SVG convertidos do Lucide React
 * 
 * Todos os ícones são inline SVG para não depender de bibliotecas externas.
 * Baseado em lucide-react v0.454.0
 */

export const LucideIcons = {
  /** Ícones de navegação e controle */
  ...
  BarChart3: `<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path d="M18 17V9"/><path d="M13 17V5"/><path d="M8 17v-3"/></svg>`,
  ...
  /** Ícones de mensagens e contatos */
...
/**
 * Função helper para inserir ícone SVG em elementos HTML
 */
export function insertIcon(element: HTMLElement, iconName: keyof typeof LucideIcons): void {
...
/**
 * Retorna HTML do ícone como string
 */
export function getIcon(iconName: keyof typeof LucideIcons): string {
